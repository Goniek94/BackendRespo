...
export const mapFormDataToBackend = (data) => {
  ...
  return {
    ...
    // Pola dla najmu (Najem)
    rentalPrice: data.rentalPrice ? parseFloat(data.rentalPrice) : null,

    // Pola dla cesji leasingu (Cesja) - NAPRAWIONE: używamy null zamiast pustego stringa
    ...
    // Pola dla zamiany (Zamiana) - NAPRAWIONE: używamy null zamiast pustego stringa
